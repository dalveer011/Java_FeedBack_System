  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li  class="active"><a href="./searchCourses">Delete Courses</a></li>
      </ul>
...
<div class="container-fluid">
    ...
    <p class="text-center">You can delete courses from here</p>
  </div>  
</div>
<div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
    	 <table class="table table-list-search">
                   ...
                   <td>${course.courseNum}</td>
                    ...
                    <td><a href="./deleteCourse?num=${course.courseNum}" class="btn btn-danger">Delete</button></td>
                    </tr>
                    </c:forEach>
                    </tbody>
                </table> 
