  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./addCourseDetails">Add Courses</a></li>
...
<div class="row">
<div class="jumbotron">
	<h1 class="text-center">Enter Course Details</h1>
</div>
<section class="col-sm-4 col-sm-offset-4">
<form method="post" action="./addcourse">
       <div class="form-group">
       <input type="text" class="form-control" name="courseNum" placeholder="Enter Course Number" required>
       </div>
       <div class="form-group">
       <input type="text" class="form-control" name="courseDescription" placeholder="Enter Course Name" required>
       </div>
       <div class="form-group">
...
<div class="modal fade" id="MessageModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <c:if test="${message == 'Course added successfully'}">
      	<p>${message}</p><br>
      <a href="./addCourseDetails" class="btn btn-success">Add Another</a>
      <a href="../admin" class="btn btn-success">Not now</a>
      </c:if>
      	<c:if test="${message != 'Course added successfully'}">
      		<p>${message}</p><br>
      	<a href="./addCourseDetails" class="btn btn-success">Ok</a>
      </c:if>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
